addLayer("p", {
    ...
    upgrades: {
        // [포인트 강화 계열 - 10개]
        11: { title: "기초", description: "포인트 +1/s", cost: new Decimal(1) },
        ...
        15: { title: "까마귀 해금", description: "까마귀 레이어를 엽니다.", cost: new Decimal(500) },
        16: { title: "로그 생산", description: "포인트 수치에 따라 생산량 증가", cost: new Decimal(2000),
        ...
        // [프레스티지 강화 계열 - 10개]
        21: { title: "혈액 순환", description: "포인트 수치로 프레스티지 포인트 증가", cost: new Decimal(20),
        ...
        25: { title: "전이", description: "까마귀가 프레스티지 포인트를 강화합니다.", cost: new Decimal(20000),
